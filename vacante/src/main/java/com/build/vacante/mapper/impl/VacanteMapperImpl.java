...
public class VacanteMapperImpl implements VacanteMapper {
    ...
    public CreateVacanteRequest fromDto(CreateVacanteRequestDto dto) {
        return new CreateVacanteRequest(dto.puesto(), dto.requisitos(), dto.empresa(), dto.modalidad(), dto.fecha_vto(), dto.estado(), dto.prioridad());
    ...
    public VacanteDto toDto(Vacante vacante) {
        return new VacanteDto(vacante.getId(), vacante.getPuesto(), vacante.getRequisitos(), vacante.getEmpresa(), vacante.getModalidad(), vacante.getFecha_vto(), vacante.getEstado(), vacante.getPrioridad());
    }
}
